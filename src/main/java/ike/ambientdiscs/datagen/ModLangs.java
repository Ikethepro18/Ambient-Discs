...
private static void addLanguageProviders(Consumer<FabricDataGenerator.Pack.RegistryDependentFactory<? extends FabricLanguageProvider>> languageProviderFactoryConsumer) {
    ...
    Map<String, String> languageToDiscName = Map.<String, String>ofEntries(
            ...
            Map.entry("en_ud", "ɔsᴉᗡ ɔᴉsnW"), Map.entry("en_us", "Music Disc"), Map.entry("eo_uy", "Sondisko"),
